...
Pending: 	Соответствует внутренним состояниям Саги Initial, AwaitingInventoryReservation, AwaitingPaymentReservation. Для UI это означает «Заказ обрабатывается системой».
Completed: 	Соответствует финальному состоянию Саги Completed. Все ресурсы успешно зафиксированы.
Cancelled: 	Соответствует состояниям Саги Cancelled. Компенсирующие транзакции завершены, заказ аннулирован.
