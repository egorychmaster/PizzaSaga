    ...
    where TMessage : ICommand<TResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        {
            // Шаг 3: Обработка race-условия — повторный SELECT
    ...
    /// </summary>
    private static TResult HandleExistingRecord<TResult>(IdempotencyRecordDto record, string requestHash)
    {
        ...
        return JsonSerializer.Deserialize<TResult>(record.ResponseBody)
